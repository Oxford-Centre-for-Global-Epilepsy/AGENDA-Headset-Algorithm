...
def objective(trial):
    ...
    with initialize(config_path="configs", version_base="1.1"):
        overrides = [
            f"component.feature_extractor.eegnet.F1={trial.suggest_int('F1', 4, 16, log=True)}",
            ...
            f"optimizer.learning_rate={trial.suggest_float('pool_lambda', 1e-4, 1e-2, log=True):8f}",
